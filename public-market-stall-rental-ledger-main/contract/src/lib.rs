...
#[contract]
pub struct PublicMarketStallRentalLedgerContract;

#[contractimpl]
impl PublicMarketStallRentalLedgerContract {
    ...
    pub fn settle_commerce_record(env: Env, id: String, actor: Address, amount: i128, score: u32) -> Result<(), Error> {
        if amount <= 0 {
            return Err(Error::InvalidAmount);
        }
